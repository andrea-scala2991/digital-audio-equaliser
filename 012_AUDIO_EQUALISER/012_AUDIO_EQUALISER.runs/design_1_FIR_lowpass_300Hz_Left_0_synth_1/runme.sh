...
HD_PWD='D:/Xilinx/projects/012_AUDIO_EQUALISER/012_AUDIO_EQUALISER.runs/design_1_FIR_lowpass_300Hz_Left_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_FIR_lowpass_300Hz_Left_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_FIR_lowpass_300Hz_Left_0.tcl
